...
typedef __packed union tag_Datc_ExvH_cmd_t
{
    struct {
        uint16_t C_ExvH_PosReq     : 16;    /**< [00] HP Exv Position Set */ 
        uint8_t C_ExvH_MoveEnable :  1;    /**< [16] HP Exv Move Enable */ /* 0x0 : Stop - 0x1 : Move to Commanded Position */
        uint8_t reserved1         :  7;    /**< [17~23] Reserved */         
        uint8_t C_ExvH_Initial    :  2;    /**< [24] HP Exv Initialization Command*/ /* 0x0 : Default - 0x1 : At B+ Initialization - 0x2 ~ 0x3 : Invalid */
        uint8_t reserved2         :  6;    /**< [26~31] Reserved */                
        uint8_t C_ExvH_LinError   :  1;    /**< [32] Master LIN Rx Error */
        uint8_t reserved3         :  7;    /**< [33~40] Reserved */
    };    
    uint8_t buff[5];    /* byte accessor */
} Hkmc_3Way_master_cmd_t;
