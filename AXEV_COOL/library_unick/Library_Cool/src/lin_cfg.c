...
const l_signal_handle LI0_response_error_signal = LI0_C_3way2_C_LinError;
...
l_u8    lin_pFrameBuf[LIN_FRAME_BUF_SIZE] =
{
  ...
  0xe2 /* 0 : 11100010 */ /* start of frame LI0_C_3way2_Datc */
  ...
  ,0xfc /* 8 : 11111100 */ /* start of frame LI0_Datc_3way2 */
...
l_u8    lin_flag_handle_tbl[LIN_FLAG_BUF_SIZE] =
{
  ...
  0xFF /* 0: start of flag frame LI0_C_3way2_Datc */

  ,0xFF /* 1: */


  ,0xFF /* 2: start of flag frame LI0_Datc_3way2 */
...
const lin_frame_struct lin_frame_tbl[LIN_NUM_OF_FRMS] ={
   ...
   ,{ LIN_FRM_UNCD, 8, LIN_RES_SUB, 8, 2, 1 , (l_u8*)0 }
...
l_u8 lin_configuration_RAM[LIN_SIZE_OF_CFG]= {0x00, 0x29, 0x28, 0x3C, 0x3D ,0xFF};


const l_u16  lin_configuration_ROM[LIN_SIZE_OF_CFG]= {0x00, 0x29, 0x28, 0x3C, 0x3D ,0xFFFF};

/***************************************** Node Attribute*****************************************/

l_u8 lin_configured_NAD = 0x01;    /*<configured_NAD>*/
const l_u8 lin_initial_NAD    =0x01;    /*<initial_NAD>*/
const lin_product_id product_id = {0x7FFE, 0xFFFE, 0x00FE };  /* {<supplier_id>,<function_id>,<variant>} */
const l_signal_handle response_error =  LI0_C_3way2_C_LinError;
const l_u8 num_frame_have_esignal = 1;                                 /*number of frame contain error signal*/
const l_u16 lin_response_error_byte_offset[1] = {LIN_BYTE_OFFSET_LI0_C_3way2_C_LinError};                  /*<interface_name>_< response_error>*/
const l_u8 lin_response_error_bit_offset[1] = {LIN_BIT_OFFSET_LI0_C_3way2_C_LinError};                  /*<interface_name>_< response_error>*/
...
const l_u8 lin_diag_services_supported[_DIAG_NUMBER_OF_SERVICES_] = {0xB2,0xB7};
