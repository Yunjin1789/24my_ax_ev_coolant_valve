...
typedef struct{
    ...
    intfunc_t _VBAT_Handler;            /* ASIC irq 4 - Under Voltage Event*/
...
__weak void BTE_Handler(void){}
__weak void SDIO_Handler(void){}


__weak void SysTick_Handler(void){}
__weak void WULIN_Handler(void){}
__weak void PWMAUX_Handler(void){}
__weak void WUTIMER_Handler(void){}
__weak void BOR_Handler(void){}
__weak void VBAT_Handler(void){}
__weak void OVTEMP_Handler(void){}
__weak void WatchdogA_Handler(void){}
__weak void GPIO_Handler(void){}
__weak void LINS_Handler(void){}
__weak void LINM_Handler(void){}
__weak void UART_Handler(void){}
__weak void ADC_Handler(void){}
__weak void PWM_Handler(void){}
__weak void BUCK_Handler(void){}
__weak void SPI_Handler(void){}
__weak void Lullaby_Handler(void){}
