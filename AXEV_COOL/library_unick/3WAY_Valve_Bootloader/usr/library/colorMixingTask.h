 ...
 *  @return 0
 */
uint8_t CLM_SetLimitedMaxIntensity(uint16_t intensity);
 ...
 *  @return 0
 */
uint8_t CLM_GetLimitedMaxIntensity(uint16_t *intensity);
 ...
 *  @return 0
 */
uint8_t CLM_SetAccurateXYY(LedNum_t ledIndex,IntensityRatio_t iRatio, int8_t temperature, uint16_t x, uint16_t y, uint8_t Y, uint16_t transitionTime);
 ...
 *  @return 0
 */
uint8_t CLM_SetAccurateLUV(LedNum_t ledIndex,IntensityRatio_t iRatio, int8_t temperature, uint16_t u, uint16_t v, uint8_t level, uint16_t transitionTime);
/*
 ...
 *  @return 0
 */
uint8_t CLM_SetAccurateRGBL(LedNum_t ledIndex,IntensityRatio_t iRatio, int8_t temperature, uint8_t red, uint8_t green, uint8_t blue,uint8_t level, uint16_t transitionTime);
 ...
 *  @return 0
 */
uint8_t CLM_SetXYY(LedNum_t ledIndex,int8_t temperature, uint16_t x, uint16_t y, uint16_t Y, uint16_t transitionTime);
 ...
 *  @return 0
 */
uint8_t CLM_SetLUV(LedNum_t ledIndex,int8_t temperature, uint16_t u, uint16_t v, uint16_t level, uint16_t transitionTime);
/*
 *  Set RGBL output 
 *  @param [in] temperature: -40-100 in 1C
 *  @param [in] red: 0-255
 ...
 *  @return 0
 */
uint8_t CLM_SetRGBL(LedNum_t ledIndex,int8_t temperature, uint8_t red, uint8_t green, uint8_t blue,uint16_t level, uint16_t transitionTime);
 ...
 *  @return 0
 */
uint8_t CLM_SetHSL(LedNum_t ledIndex,int8_t temperature, uint16_t hue, uint8_t saturation, uint16_t level, uint16_t transitionTime);
/*
 *  Set RGB output 
 *  @param [in] temperature: -40-100 in 1C
 *  @param [in] red: 0-255
 ...
 *  @return 0
 */
uint8_t CLM_SetRGB(LedNum_t ledIndex,int8_t temperature, uint8_t red, uint8_t green, uint8_t blue, uint16_t transitionTime);
 ...
 */ 
ColorParam_t *CLM_GetCurrentColorParams(LedNum_t ledIndex);
 ...
 *  @return 0
 */
uint8_t CLM_SetLedPhyParams(LedNum_t ledIndex,int8_t temperature, LedcolorParam_t *param);
 ...
 *  @return 0
 */
uint8_t CLM_GetLedPhyParams(LedNum_t ledIndex,int8_t temperature, LedcolorParam_t *param); 
 ...
 *  @return 0
 */
uint8_t CLM_SetWhitePointParams(Coordinate_t const *coordinate);
 ...
 *  @return 0
 */
uint8_t CLM_SetLedPNVolts(LedNum_t ledIndex,int8_t temperature, int16_t volt_R, int16_t volt_G, int16_t volt_B);
 ...
 *  @return 0
 */
uint8_t CLM_GetLedPNVolts(LedNum_t ledIndex,int8_t temperature, int16_t *const volt_R, int16_t *const volt_G, int16_t *const volt_B);
 ...
 *  @return 0
 */
int8_t CLM_SetTypicalMaxIntensity(LedNum_t ledIndex,uint16_t redIntensity,uint16_t greenIntensity,uint16_t blueIntensity);
 ...
 *  @return 0
 */
int8_t CLM_GetTypicalMaxIntensity(LedNum_t ledIndex,uint16_t *redIntensity,uint16_t *greenIntensity,uint16_t *blueIntensity);
 ...
 *  @return 0
 */
uint8_t CLM_CalculatingWhitePoint(LedNum_t ledIndex,int8_t temperature,Coordinate_t *whitePoint);
 ...
 */
uint8_t CLM_StoragColorParams(void);

/*
 * call this function before using color mixing task and functions
 *  @return none
 */
void CLM_Init(void);
