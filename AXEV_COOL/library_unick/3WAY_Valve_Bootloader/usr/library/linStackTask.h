...
/*
 *  Set Linm phy 1st rx glitch signal filter timing : 
 *  @param [in] risingTime: level 0 -> level1 delay time;  range 0-127 unit: 62.5us
 *  @param [in] fallingTime:level 0 -> level 1 delay time, range 0-127 unit: 62.5us
 *  @return 0, successfully , others: failed
 */
l_u8 ls_set_linm_rx_glitch_filter_1st(l_u8 risingTime,l_u8 fallingTime);

/*
 *  Set Linm phy 2nd rx glitch signal filter timing : 
 *  @param [in] risingTime: level 0 -> level1 delay time;  range 0-127 unit: 62.5us
 *  @param [in] fallingTime:level 0 -> level 1 delay time, range 0-127 unit: 62.5us
 *  @return 0, successfully , others: failed
 */
l_u8 ls_set_linm_rx_glitch_filter_2nd(l_u8 risingTime,l_u8 fallingTime);


/*
 *  Set Linm phy 3rd rx glitch signal filter timing : 
 *  @param [in] risingTime: level 0 -> level1 delay time;  range 0-127 unit: 62.5us
 *  @param [in] fallingTime:level 0 -> level 1 delay time, range 0-127 unit: 62.5us
 *  @return 0, successfully , others: failed
 */
l_u8 ls_set_linm_rx_glitch_filter_3rd(l_u8 risingTime,l_u8 fallingTime);
